...
-(id)initWithGroupId:(NSString*)groupId index:(NSUInteger)index
      clickDownImage:(UIImage *)downImage clickUpImage:(UIImage *)upImage{
    self = [self init];
    if (self) {
        _groupId = groupId;
        _index = index;
        self.backGroundDownImage = downImage;
        self.backGroundUpImage   = upImage;
...
-(void)defaultInit{
    ...
    [_button setImage:self.backGroundUpImage forState:UIControlStateNormal];
    [_button setImage:self.backGroundDownImage forState:UIControlStateSelected];
